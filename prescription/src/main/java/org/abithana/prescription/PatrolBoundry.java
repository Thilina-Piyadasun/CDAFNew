...
public class PatrolBoundry implements Serializable {
    ...
    public void findPatrolBoundries(){
        ...
        for(LeaderBean leaderBean:leaderList){
            ...
            for(int i:leaderBean.getFollowers()){
                System.out.print(i + "  ");
            }
            System.out.println();
        }
    ...
    public void findPatrolBoundries2(){
        ...
        for(TractCentroidBean centroidBean:follwers){
            ...
            for(int i=0;i<leaderList.size();i++){
                ...
                if(isNeighbour(leaderBean,centroidBean.getTractID())){
        ...
        for(LeaderBean leaderBean:leaderList){
            System.out.println("================Leader "+leaderBean.getLeaderTract()+"=================");
            for(int i:leaderBean.getFollowers()){
                System.out.print(i + "  ");
            }
            System.out.println();
    ...
    public boolean isNeighbour(LeaderBean leaderBean,int tractID){
    ...
    public Set<Integer> collectAllNeighbours(LeaderBean leaderBean){

        Set<Integer> allNeighbours=new HashSet<>();
